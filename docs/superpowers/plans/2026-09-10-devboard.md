...
- [x] **Step 3: Write the listener fixture**
...
- [x] **Step 3: Write scanners and discover()**
...
- [x] **Step 4: Run the live test and the whole suite**
...
- [x] **Step 1: Create a placeholder page**
...
- [x] **Step 1: Tighten the page test**
...
- [x] **Step 2: Run the smoke checklist end to end**
...
- [x] **Step 3: Measure the poll cost**
